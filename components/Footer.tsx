      ...
      <div className="grid justify-between grid-cols-2 py-20">
        <div>
          ...
          <p className="leading-8 text-white ">
            Are you considering a fresh idea and seeking for someone who can
            make it a reality? Let&apos;s get together with me. I eagerly
            anticipate your message.
          </p>
          ...
          <div className="flex gap-8 mt-10">
            ...
            <a
              href="https://twitter.com/rayhan095"
              target="_blank"
              rel="noreferrer"
            >
              <svg
